    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Ver actuaciones',
                    'route'  => 'admin.actuaciones.index',
                ],
                [
                    'text' => 'Crear actuación',
                    'route'  => 'admin.actuaciones.create',
                ],
            ],
        ],
        [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Ver circuitos',
                    'route'  => 'admin.circuitos.index',
                ],
                [
                    'text' => 'Crear circuito',
                    'route'  => 'admin.circuitos.create',
                ],
