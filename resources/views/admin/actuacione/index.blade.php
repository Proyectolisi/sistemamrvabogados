                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                             ...
                             <div class="float-right">
                                <a href="{{ route('admin.actuaciones.create') }}" class="btn btn-primary btn float-right"  data-placement="left">
                                ...
                                <tbody>
                                    @foreach ($actuaciones as $actuacione)
                                        <tr>
											...
											<td>{{ $actuacione->tipo_actuacion_id }}</td>
                                            ...
                                            <td>
                                                <form action="{{ route('admin.actuaciones.destroy',$actuacione->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('admin.actuaciones.show',$actuacione->id) }}"><i class="fa fa-fw fa-eye"></i> Mostrar</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('admin.actuaciones.edit',$actuacione->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
