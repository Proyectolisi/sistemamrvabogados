<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('fecha_actuacion', $actuacione->fecha_actuacion, ['class' => 'form-control' . ($errors->has('fecha_actuacion') ? ' is-invalid' : ''), 'placeholder' => 'Fecha Actuacion']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('anotacion', $actuacione->anotacion, ['class' => 'form-control' . ($errors->has('anotacion') ? ' is-invalid' : ''), 'placeholder' => 'Anotacion']) }}
            {!! $errors->first('anotacion', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <br>
        <div class="form-group">
            {{ Form::label('Fecha de Inicio del Termino:') }}
            {{ Form::text('fecha_inicio_termino', $actuacione->fecha_inicio_termino, ['class' => 'form-control' . ($errors->has('fecha_inicio_termino') ? ' is-invalid' : ''), 'placeholder' => 'Fecha Inicio Termino']) }}
            {!! $errors->first('fecha_inicio_termino', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <br>
        <div class="form-group">
            {{ Form::label('Fecha de Finalización del Termino:') }}
            {{ Form::text('fecha_finaliza_termino', $actuacione->fecha_finaliza_termino, ['class' => 'form-control' . ($errors->has('fecha_finaliza_termino') ? ' is-invalid' : ''), 'placeholder' => 'Fecha Finaliza Termino']) }}
            {!! $errors->first('fecha_finaliza_termino', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <br>
        <div class="form-group">
            {{ Form::label('Fecha de Registro:') }}
            {{ Form::text('fecha_registro', $actuacione->fecha_registro, ['class' => 'form-control' . ($errors->has('fecha_registro') ? ' is-invalid' : ''), 'placeholder' => 'Fecha Registro']) }}
            {!! $errors->first('fecha_registro', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <br>
        <div class="form-group">            
            {{ Form::label('Archivo:') }}
            {{ Form::text('file', $actuacione->file, ['class' => 'form-control-file' . ($errors->has('file') ? ' is-invalid' : '')]) }}
    ...
    <div class="box-footer mt20">
        <a class="btn btn-secondary" href="{{ route('actuaciones.index') }}"> Regresar</a>
