@extends('layouts.main', ['activePage' => 'procesos', 'titlePage' => __('Procesos')])
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="float-left">
                        <h2>Listado de Procesos</h2></span>
                        </div>
                </div>
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                             ...
                             <div class="float-right">
                                <a href="{{ route('procesos.create') }}" class="btn btn-primary float-right"  data-placement="left">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('procesos.destroy',$proceso->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('procesos.show',$proceso->id) }}"><i class="fa fa-fw fa-eye"></i> Mostrar</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('procesos.edit',$proceso->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
